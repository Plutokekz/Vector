...
import qualified Lexer as L  -- Import Lexer qualified
import Lexer (TokenPos(..))  -- Still import TokenPos directly as it's not ambiguous
...
parseFactor = do
    ...
    case tok of
        ...
        L.LBracket -> do  -- Handle matrix literals
            advance
